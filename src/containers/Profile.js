...
const Profile = () => {
    ...
    const handleProfileUpdateSubmit = async (event) => {
        ...
        await updateProfile({email: currentUser.email, firstName: newProfile.firstName, lastName: newProfile.lastName, 
                              mobileNo: newProfile.mobileNo, dateOfBirth: newProfile.dateOfBirth});
                ...
                <div className='home_head'>
                    <h2>จัดการบัญชีผู้ใช้</h2>
                        <div class="container">
                            ...
                            <div class="col-12 col-lg-10 col-xl-8 mx-auto"><div class="my-4">
                                <form>
